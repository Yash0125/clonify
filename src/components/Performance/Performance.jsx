...
const Performance = ({data}) => {
  return (
    <div className="performance-container">
      ...
      <AreaChart data={data} margin={{ top: 50, right: 30, left: 0, bottom: 0 }}>
        <defs>
        ...
        <YAxis strokeWidth={0}  />
        {/* <Tooltip /> */}
        <Area  dot={false} type="monotone" dataKey="uv" stroke="#679CF6" strokeWidth={3} fillOpacity={1} fill="#4285F440" />
        <Area  dot={false} type="monotone" dataKey="pv" stroke="#20C997" strokeWidth={3} fillOpacity={1} fill="url(#colorPv)" />
      </AreaChart>
    </ResponsiveContainer>
